...
class TodoList extends Component {
    ...
    updateTodoClick(id,btnName){
        var data = {id:id,task:this.state.inputText,btnName:btnName}
                        ...
                        <tbody>
                            {this.props.todos.map(todos => (
                                <tr key={todos.id}>
                                    <td>{todos.isDone ? "✓" : ""}</td>
                                    <td>{todos.task}</td>
                                    <td><button onClick={()=>this.deleteTodoClick(todos.id)}>DELETE</button>
                                        <button onClick={()=>this.updateTodoClick(todos.id,"EDIT")}>UPDATE</button>
                                        <button onClick={()=>this.updateTodoClick(todos.id,"CHECK")}>COMPLETED</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>

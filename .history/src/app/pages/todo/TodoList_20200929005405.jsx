...
class TodoList extends Component {
    ...
    updateTodoClick(id,btnName,isDone,task){
        var data = {
            id:id,
            task:this.state.inputText,
            isDone:isDone,
                            ...
                            {this.props.todos.map(todos => (
                                <tr key={todos.id}>
                                    ...
                                    <td><button onClick={()=>this.deleteTodoClick(todos.id,todos.isDone)}>DELETE</button>
                                        <button onClick={()=>this.updateTodoClick(todos.id,"EDIT",todos.isDone,todos.task)}>UPDATE</button>
                                        <button onClick={()=>this.updateTodoClick(todos.id,"CHECK",todos.isDone,todos.task)}>COMPLETED</button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
